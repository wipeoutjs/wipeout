...
test("binding, nb", function () {
	...
	var viewModel = new obsjs.observable(),
		setter = new wipeout.template.propertySetter(new wipeout.template.templateAttribute("true", null)),
		name = "KJBKJBKJB",
...
test("binding, bindOneWay", function () {
	// arrange
	var viewModel = new obsjs.observable(),
		setter = new wipeout.template.propertySetter(new wipeout.template.templateAttribute("$parent.val", null)),
		name = "KJBKJBKJB",
		renderContext = new wipeout.template.renderContext(new obsjs.observable()).childContext(viewModel);
