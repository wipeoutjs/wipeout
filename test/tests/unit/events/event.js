...
testUtils.testWithUtils("event", "constructor, trigger, register, unregister", false, function(methods, classes, subject, invoker) {
    ...
    // inital
    var dispose1 = wipeout.events.event.instance.register(subject, event, callback1, context);
    var dispose2 = wipeout.events.event.instance.register(subject, event, callback2, context);
    
    wipeout.events.event.instance.trigger(subject, event, eventArgs);    
...
testUtils.testWithUtils("event", "dispose is unique", false, function(methods, classes, subject, invoker) {
    ...
    // inital
    var dispose1 = wipeout.events.event.instance.register(subject, event, callback1, context);
    var dispose2 = wipeout.events.event.instance.register(subject, event, callback1, context);
    
    ok(wipeout.events.event.instance.dictionary.objects.value(subject));
...
testUtils.testWithUtils("event", "priority", false, function(methods, classes, subject, invoker) {
    ...
    var dispose1 = wipeout.events.event.instance.register(subject, event, callback3, null, -10);
    var dispose2 = wipeout.events.event.instance.register(subject, event, callback1, null, 10);
    var dispose3 = wipeout.events.event.instance.register(subject, event, callback2, null);
    
    wipeout.events.event.instance.trigger(subject, event);
